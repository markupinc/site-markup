...
/**
 * Landing page de campanha (/lp) — foco em investidores.
 * Standalone: sem navbar/menu para não vazar o tráfego pago; CTAs = WhatsApp + empreendimentos.
 */
...
export default async function LpPage() {
  ...
  return (
    <main className="bg-[#0a0a0a] text-white" style={{ fontFamily: "var(--font-inter)", lineHeight: 1.5 }}>
      {/* HEADER — só a logo, sem navegação (página de campanha) */}

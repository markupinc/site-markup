...
// Home institucional original, preservada em slug não-listado (a raiz virou a LP).
// Fora do sitemap e com noindex para o Google não indexar a duplicata.
export const metadata = {
  title: "Markup Incorporações — Institucional",
